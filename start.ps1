...
param(
    [string]$BindIP = ""   # Override: .\start.ps1 -BindIP 192.168.1.50
)
...
Write-Host "[4/5] Configuring frontend API URL -> $BackendUrl/api ..." -ForegroundColor Yellow
@"
...
Write-Host ''
npx ng serve --host 0.0.0.0 --port 4200 --configuration development
"@
